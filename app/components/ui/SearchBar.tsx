    ...
    >
      <div className="w-full md:w-1/2 flex">
        <input
          ...
          className="flex-1 px-4 py-3 border bg-gray-100 border-gray-300 rounded-l-full shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-400 text-lg"
        />
        <button
          type="submit"
          className="px-6 py-3 bg-gray-900 text-gray-50 font-semibold rounded-r-full transition-colors text-lg"
        >
