...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    ...
    //   </div>
    // </Link>
    <article className="product_card md:h-[430px] h-[180px] group block bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300   w-full overflow-clip card card">
      ...
      <div className="card_content_product md:p-4 px-2 py-3">
        <span className="product">
          {/* <p className="text-xs text-gray-800 font-medium uppercase">{brand}</p> */}
